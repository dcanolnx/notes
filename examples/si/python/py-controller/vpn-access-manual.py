...
#    launch_ansible('pdiaz',ansible_playbook)
#    launch_ansible('jgutierrez',ansible_playbook)
#    launch_ansible('pdiaz',ansible_playbook)
#    launch_ansible('pdiaz',ansible_playbook)
#    user_input = input("Please enter a value to pass to Ansible: ")
#    launch_ansible(user_input,ansible_playbook)
    if len(sys.argv) != 2:
        print("Usage: python script.py <argument>")
        sys.exit(1)

    argument = sys.argv[1]
    launch_ansible(argument,ansible_playbook)
